...
public class DemoSpringBootApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("Records added successfully."); 
	      ...
	      List<CustomerClassPRojection> customerDTO = service.findbyName("Lucy");
	      logger.info("Customer Details:"); 



         for (CustomerClassPRojection customerProjectionDTO : customerDTO) {
        	 System.out.println(customerProjectionDTO);
        	 }
