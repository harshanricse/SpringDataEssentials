...
public class CustomerServiceImpl implements CustomerService {
	...
	@Override
	@Cacheable(value="customerCache",key="#customerId")//to store data in cache
	...
	@Override
	@CachePut(value="customerCache",key="#customerId")//for updating the data in cache
	...
	@Override
	@CacheEvict(value="customerCache",key="#customerId")//to evict the data in cache
